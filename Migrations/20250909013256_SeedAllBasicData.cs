...
{
    /// <inheritdoc />
    public partial class SeedAllBasicData : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "CreatedAt", "ForClient", "ModifiedAt", "Type" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), true, null, "تأخر العامل" },
                    { 2, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), true, null, "آداء العامل ليس احترافيا" },
                    { 3, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), true, null, "المواد المستخدمة رديئة" },
                    { 4, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), true, null, "مشكلة في الدفع" },
                    { 5, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), true, null, "أسلوب غير لائق" },
                    { 6, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), true, null, "أخرى" },
                    { 7, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), false, null, "العميل غير موجود في الموعد" },
                    { 8, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), false, null, "أسلوب العميل غير لائق" },
                    { 9, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), false, null, "طلب العميل غير متوفر" },
                    { 10, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), false, null, "مشكلة في الدفع" },
                    { 11, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), false, null, "العميل طلب خدمات اضافية" },
                    { 12, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), false, null, "أخرى" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), "CommissionFee", false, false, 25.0, 200.0, 25.0, null, null },
                    { 2, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), "VisitingFee", false, false, 15.0, 180.0, 15.0, null, null },
                    { 3, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), "CancellationFee", false, false, 18.0, 300.0, 20.0, null, null },
                    { 4, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), "ClientIndebtednessFee", false, false, 0.0, 250.0, 0.0, null, null },
                    { 5, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), "WorkerIndebtednessFee", false, false, 0.0, 200.0, 0.0, null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), true, null, "تم قبول طلبك. اضغط هنا للذهاب إلى تفاصيل الطلب.", "الطلب مقبول" },
                    { 2, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), true, null, "تم تأكيد طلبك. اضغط هنا لاختيار احد العروض المقدمة من العمال.", "تم تأكيد الطلب" },
                    { 3, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), true, null, "تم قبول العرض المقدم من العامل. اضغط هنا لاستكمال الدفع.", "تم تعيين العامل" },
                    { 4, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), true, null, "تم انتهاء طلبك. اضغط هنا لتقييم مدى رضاك عن آداء العامل.", "انتهاء الطلب" },
                    { 5, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), true, null, "تم إلغاء طلبك. اذا كنت مازلت تحتاج الخدمة برجاء انشاء طلب جديد.", "الطلب ملغي" },
                    { 6, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), true, null, " تفاصيل الاشعار.", "اشعار جديد" },
                    { 7, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), false, null, "تم قبول عرضك على الطلب رقم <id># اضغط هنا للذهاب إلى تفاصيل الطلب.", "العرض مقبول" },
                    { 8, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), false, null, "تم إضافة مبلغ <price> دينار إلى محفظتك لدفع رسوم الطلب رقم <id>#. الذهاب الى المحفظة", "تم تعديل الرصيد" },
                    { 9, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), false, null, "يتوافق الطلب رقم <id># مع خدماتك. اضغط هنا للاطلاع على التفاصيل ", "طلب خدمة جديد" },
                    { 10, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), false, null, "تم انتهاء الطلب رقم <id># اضغط هنا لتقييم تجربتك مع العميل.", "انتهاء الطلب" },
                    { 11, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), false, null, "تم إلغاء الطلب رقم <id># وإلغاء الموعد المسجل لتقديم الخدمة.", "الطلب ملغي" },
                    { 12, new DateTime(2025, 7, 20, 23, 16, 34, 134, DateTimeKind.Utc), false, null, "تفاصيل الاشعار.", "اشعار جديد" }
                });
