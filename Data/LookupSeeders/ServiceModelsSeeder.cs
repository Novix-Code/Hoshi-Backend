    ...
    public static class ServiceModelsSeeder
    {
        ...
        private static void SeedJobServices(ModelBuilder modelBuilder)
        {
            var jobServices = new List<JobService>
            {
                ...
                new JobService { Id = 1, JobId = 1, ServiceId = 1, CreatedAt = createdAt },
                new JobService { Id = 2, JobId = 1, ServiceId = 2, CreatedAt = createdAt },
                new JobService { Id = 3, JobId = 1, ServiceId = 3, CreatedAt = createdAt },
                new JobService { Id = 4, JobId = 1, ServiceId = 4, CreatedAt = createdAt },
                new JobService { Id = 5, JobId = 1, ServiceId = 5, CreatedAt = createdAt },

                // فني صيانة عامة (Job 2) - General Maintenance (6-9)
                new JobService { Id = 6, JobId = 2, ServiceId = 6, CreatedAt = createdAt },
                new JobService { Id = 7, JobId = 2, ServiceId = 7, CreatedAt = createdAt },
                new JobService { Id = 8, JobId = 2, ServiceId = 8, CreatedAt = createdAt },
                new JobService { Id = 9, JobId = 2, ServiceId = 9, CreatedAt = createdAt },

                // كهربائي (Job 3) - Electrical Services (10-13)
                new JobService { Id = 10, JobId = 3, ServiceId = 10, CreatedAt = createdAt },
                new JobService { Id = 11, JobId = 3, ServiceId = 11, CreatedAt = createdAt },
                new JobService { Id = 12, JobId = 3, ServiceId = 12, CreatedAt = createdAt },
                new JobService { Id = 13, JobId = 3, ServiceId = 13, CreatedAt = createdAt },

                // سباك (Job 4) - Plumbing Services (14-17)
                new JobService { Id = 14, JobId = 4, ServiceId = 14, CreatedAt = createdAt },
                new JobService { Id = 15, JobId = 4, ServiceId = 15, CreatedAt = createdAt },
                new JobService { Id = 16, JobId = 4, ServiceId = 16, CreatedAt = createdAt },
                new JobService { Id = 17, JobId = 4, ServiceId = 17, CreatedAt = createdAt },

                // فني تكييف وتبريد (Job 5) - AC & Cooling (18-20)
                new JobService { Id = 18, JobId = 5, ServiceId = 18, CreatedAt = createdAt },
                new JobService { Id = 19, JobId = 5, ServiceId = 19, CreatedAt = createdAt },
                new JobService { Id = 20, JobId = 5, ServiceId = 20, CreatedAt = createdAt },

                // دهان (Job 6) - Painting Services (21-23)
                new JobService { Id = 21, JobId = 6, ServiceId = 21, CreatedAt = createdAt },
                new JobService { Id = 22, JobId = 6, ServiceId = 22, CreatedAt = createdAt },
                new JobService { Id = 23, JobId = 6, ServiceId = 23, CreatedAt = createdAt },

                // نجار (Job 7) - Carpentry Services (25-27)
                new JobService { Id = 24, JobId = 7, ServiceId = 25, CreatedAt = createdAt },
                new JobService { Id = 25, JobId = 7, ServiceId = 26, CreatedAt = createdAt },
                new JobService { Id = 26, JobId = 7, ServiceId = 27, CreatedAt = createdAt },

                // مهندس ديكور (Job 8) - Interior Design (24)
                new JobService { Id = 27, JobId = 8, ServiceId = 24, CreatedAt = createdAt },
                new JobService { Id = 28, JobId = 8, ServiceId = 23, CreatedAt = createdAt },

                // بستاني (Job 9) - Gardening Services (28-30)
                new JobService { Id = 29, JobId = 9, ServiceId = 28, CreatedAt = createdAt },
                new JobService { Id = 30, JobId = 9, ServiceId = 29, CreatedAt = createdAt },
                new JobService { Id = 31, JobId = 9, ServiceId = 30, CreatedAt = createdAt },

                // ميكانيكي سيارات (Job 10) - Car Services (31-33)
                new JobService { Id = 32, JobId = 10, ServiceId = 31, CreatedAt = createdAt },
                new JobService { Id = 33, JobId = 10, ServiceId = 32, CreatedAt = createdAt },
                new JobService { Id = 34, JobId = 10, ServiceId = 33, CreatedAt = createdAt },

                // سائق توصيل (Job 11) - Delivery Services (34, 36)
                new JobService { Id = 35, JobId = 11, ServiceId = 34, CreatedAt = createdAt },
                new JobService { Id = 36, JobId = 11, ServiceId = 36, CreatedAt = createdAt },

                // فني كمبيوتر (Job 12) - Computer Services (37, 38)
                new JobService { Id = 37, JobId = 12, ServiceId = 37, CreatedAt = createdAt },
                new JobService { Id = 38, JobId = 12, ServiceId = 38, CreatedAt = createdAt },

                // مبرمج (Job 13) - Programming Service (39)
                new JobService { Id = 39, JobId = 13, ServiceId = 39, CreatedAt = createdAt },

                // حارس أمن (Job 14) - Security Service (40)
                new JobService { Id = 40, JobId = 14, ServiceId = 40, CreatedAt = createdAt },

                // فني أنظمة أمان (Job 15) - Security Systems (13, 41)
                new JobService { Id = 41, JobId = 15, ServiceId = 13, CreatedAt = createdAt },
                new JobService { Id = 42, JobId = 15, ServiceId = 41, CreatedAt = createdAt },

                // عامل نقل (Job 16) - Moving Service (35)
                new JobService { Id = 43, JobId = 16, ServiceId = 35, CreatedAt = createdAt },

                // مصمم حدائق (Job 17) - Garden Design (28)
                new JobService { Id = 44, JobId = 17, ServiceId = 28, CreatedAt = createdAt },

                // فني أجهزة منزلية (Job 18) - Appliance Repair (6, 20)
                new JobService { Id = 45, JobId = 18, ServiceId = 6, CreatedAt = createdAt },
                new JobService { Id = 46, JobId = 18, ServiceId = 20, CreatedAt = createdAt }
            };
