...
namespace Hoshi.Controllers.DashboardMdoels.StatisticsControllers.CategoryRequestRateControllers
{
        ...
        CategoryRequestRateGetDTO>
    {
        ...
        ) : base(genericFSPService)
        {
			...
			includes = [
				$"{nameof(CategoryRequestRate.ServiceCategory)}.{nameof(ServiceCategory.Services)}",
			];
        }
