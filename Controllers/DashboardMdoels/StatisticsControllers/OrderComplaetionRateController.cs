...
namespace Hoshi.Controllers.DashboardMdoels.StatisticsControllers.OrderComplaetionRateControllers
{
        ...
        OrderComplaetionRateGetDTO>
    {
        ...
        ) : base(genericFSPService)
        {
			...
			includes = [
				$"{nameof(OrderComplaetionRate.ServiceCategory)}.{nameof(ServiceCategory.Services)}",
			];
        }
